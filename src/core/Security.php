...
class Security
{
    ...
    */
    ...
    protected function closeSession()
    {
        ...
        $time = time() - 3600 * 4;
        setcookie('USER', '', $time, '/');
        header('location: ' . $GLOBALS['config']['checkSession_redirect']['route']);
    }
    /*
    * ==========================================================
    *     EMAILS
    ...
    */
    protected function email($email, $subject, $body)
    {
        ...
        $mail->SMTPSecure = 'ssl';
        $mail->SMTPAuth = true;
        $mail->Username = 'Netmind2021';
        $mail->Password = '2021Netmind2021';
        $mail->setFrom('netmind2021@gmail.com', 'MVC-PHP-2021');
